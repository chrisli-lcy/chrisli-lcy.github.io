...
• 1. Dental Foundation Models (The BigMouth Project)[Project number:[BM-DR43](https://www.uth.edu/bigmouth/research-publications)]: Developing the first large-scale foundation model for dentistry trained on 4M+ longitudinal EHRs. Leveraging MedEncoder and Mamba architectures to enable multi-institutional clinical prediction and patient trajectory analysis.
...
For more information, please check out my [CV](https://github.com/chrisli-lcy/chrisli-lcy.github.io/blob/master/assets/Chenyuan_Li_CI_2026_Academia.pdf) and [research updates](https://scholar.google.com/citations?user=SJm-RW4AAAAJ&hl=en).
